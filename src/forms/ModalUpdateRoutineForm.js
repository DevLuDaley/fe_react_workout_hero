...
const ModalUpdateRoutineForm = (props) => (
    // classes = props
...
// export default ModalUpdateRoutineForm;
export default compose(connect(), withStyles(StyledSubmitBtns),)(ModalUpdateRoutineForm);