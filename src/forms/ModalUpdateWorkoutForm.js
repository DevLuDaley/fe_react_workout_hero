...
const ModalUpdateWorkoutForm = (props) => (
    // classes = props
...
// export default ModalUpdateWorkoutForm;
export default compose(connect(), withStyles(StyledSubmitBtns),)(ModalUpdateWorkoutForm);